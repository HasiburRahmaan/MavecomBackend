...
const {TopPreferableProduct,validationTopPreferableProduct} = require("../../models/customer/topPreferableProduct");
...
exports.deleteTopPreferableProduct = async (req,res)=>{
    ...
    const topPreferableProduct = await TopPreferableProduct.findById(req.params.customerId);
    let result = null;
...
exports.updateTopPreferableProduct = async (req,res)=>{
    ...
    const result = await TopPreferableProduct.findByIdAndUpdate(req.params.customerId,{
        $set:req.body
    });
